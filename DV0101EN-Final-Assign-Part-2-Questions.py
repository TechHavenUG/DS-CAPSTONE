...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign':'center','font-size':'24','color':'#503D36'}),#Include style for title
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle_Type',
            y='Automobile_Sales',
            title="Average Automobile Sales distributions by type over Recession Period",
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(
            ...
            labels={'Year': 'Years', 'Automobile_Sales': 'Average Automobile Sales'},
                 ))
...
# Plot 2 Total Monthly Automobile sales using line chart.
	...
	# Hint:Use the columns Month and Automobile_Sales.
        ...
        Y_chart2 = dcc.Graph(figure=px.line(mas,
            ...
            labels={'Month': 'Months', 'Automobile_Sales': 'Total Automobile Sales'},
            ))
